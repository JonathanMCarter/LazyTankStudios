 ...
 * Last edit: 03/11/19
 * Reason: Camera.main accesses the mobile camera and not the main camera
 */
public class CameraMove : MonoBehaviour
{
    ...
    void Update()
    {
        if (GameObject.Find("Boundary"))
        {
            ...
            cam.size = new Vector2(GetComponent<Camera>().orthographicSize * 2 * GetComponent<Camera>().aspect, GetComponent<Camera>().orthographicSize * 2);
