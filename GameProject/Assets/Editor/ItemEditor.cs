...
/*
    ...
    Date Edited Last: 13/10/19 - Script Depreciated - but kept in for the time being incase future changes to items are made or if the designers want a tool to make prefabs for items

    Edit History:
    - (Toby Wishart) - 11/10/19 - Items have completely changed, might not need this anymore
...
public class ItemEditor : EditorWindow
{
    ...
    [MenuItem("Tools/Depreciated/Item Editor", priority = 100)]
    ...
    private void OnGUI()
    {
        EditorGUILayout.HelpBox("Tool Depreciated\n\nIf a item editor is still needed plase let me know so I can work on it. \n\nThe code is still here in case it is needed again in the future, as editor is ignored in the calculations for file size.", MessageType.Error);
